...
!!! question "¿Dónde se produce el error?"
...
!!! question "Excesiva duplicación de código"
    ...
    ¿Cómo evitar la excesiva duplicación?
...
!!! note "Lecturas recomendadas"
    - [ ] Leer el [Tutorial de `Option`](https://www.tutorialspoint.com/scala/scala_options.htm) en Scala
